...
Admin
1.	Đăng nhập qua admin/login.php.
2.	Xem tổng quan tại dashboard.php.
3.	Quản lý sản phẩm (product_manage.php), đơn hàng (order_manage.php), khuyến mãi (promotion_manage.php), doanh thu (revenue.php).
